...
const (
	LogService_GetLogs_FullMethodName = "/logging.LogService/GetLogs"
)
...
func (c *logServiceClient) GetLogs(ctx context.Context, in *LogRequest, opts ...grpc.CallOption) (*LogResponse, error) {
...
func (UnimplementedLogServiceServer) GetLogs(context.Context, *LogRequest) (*LogResponse, error) {
...
func _LogService_GetLogs_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LogServiceServer).GetLogs(ctx, req.(*LogRequest))
	}
...
var LogService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/transaction/logging/logging.proto",
}
